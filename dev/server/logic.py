...
class ServerLogic:
    def __init__(self):
        self.__dataBaseDriver = DataBaseDriver("bolt://neo4j:7687", "neo4j", "Andrew_07072002")
    ...
    def searchSutableRoutes (self, body):
        ...
        if (body['selectedStrtPoint'] != '' and body['selectedEndPoint'] != '' and
            ...
            autogeneratedRoutes = self.__dataBaseDriver.generateRoutesByStartAndFinishPoint(aproximatedStartPoint[0], aproximatedEndPoint[0], stringWithTags, body)
        ...
        return {"userRoutes" : [node['n'] for node in res],
                "autogeneratedRoutes" : autogeneratedRoutes} #[node['n'] for node in res]}#autogeneratedRoutes}
    ...
    def checkIfUsersExist(self):
        return self.__dataBaseDriver.checkIfUsersExist()
    
    def createDefaultUsers(self):
        self.__dataBaseDriver.createDefaultUser()
        self.__dataBaseDriver.createDefaultAdmin()
